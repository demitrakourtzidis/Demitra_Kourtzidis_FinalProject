...
At the beginning of this project, I had a very broad idea of what I wanted to do. Criminal justice policy is something I'm extremely passionate about, so my first instinct was to include everything I thought was important (which is everything). That quickly became disjointed and overwhelming because I've taken multiple classes on criminal justice policy and written a 52-page qualitative analysis of criminal justice reform. It turns out it's hard to communicated two years worth of education into a reasonably-sized final project. I narrowed it down by picking out the two points I thought were most important: mass incarceration exists, and prisons don't help anything. If anyone gets anything from my project, I want it to be those two things. 

When first developing the aesthetics of my website, I created a moodboard to sort out a color scheme. I knew from the start that I didn't want everything to be black and orange. I think that color combination looks dismal. However, when you think "incarceration," that's what comes to mind. To mellow out the moodboard, I used images that represented the antithesis of incarceration, which I believe is "freedom." That's why the background of my title section is a blue sky. Imagery of the sky evokes feelings of freedom and limitlessness. I think freedom and incarceration are two sides of the same coin. In using pictures that represented freedom and incarceration, a color scheme emerged naturally. Orange still made the cut, but it was offset by a lot of blue. The combination of the two gave me the feeling that I wanted my website to represent. Orange and blue together feels more hopeful.

Part of me was tempted to make a bunch of complicated data visualizations just for the sake of looking impressive, but I realized I cared much more about potentially teaching someone about mass incarceration than impressing the grader (no offense, Chris, you rock). Plus, I think a big takeaway of the class was that data visualizations are like the ensemble cast of a musical, not the star of the show. The information you're conveying is the most important part (although, alluvial diagrams are really cool, and I wish there'd been a place for one in my project). I want to keep working on this website when I have more free time, in the future. I started to get excited about the idea of being able to communicate information in a simple and visually interesting way. With some fine tuning, this will be a pretty cool resource. 
